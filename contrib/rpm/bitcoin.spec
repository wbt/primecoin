...
Source10:	https://raw.githubusercontent.com/bitcoin/bitcoin/v%{version}/contrib/debian/examples/primecoin.conf
...
cp -p %{SOURCE10} ./primecoin.conf.example
tar -zxf %{SOURCE1}
...
cat <<EOF > %{buildroot}%{_tmpfilesdir}/primecoin.conf
d /run/bitcoind 0750 bitcoin bitcoin -
EOF
touch -a -m -t 201504280000 %{buildroot}%{_tmpfilesdir}/primecoin.conf
...
CONFIG_FILE="%{_sysconfdir}/bitcoin/primecoin.conf"
DATA_DIR="%{_localstatedir}/lib/bitcoin"
PID_FILE="/run/bitcoind/primecoind.pid"
EOF
...
%doc COPYING primecoin.conf.example doc/README.md doc/bips.md doc/files.md doc/multiwallet-qt.md doc/reduce-traffic.md doc/release-notes.md doc/tor.md
...
%defattr(-,root,root,-)
%license COPYING db-%{bdbv}.NC-LICENSE
%doc COPYING primecoin.conf.example doc/README.md doc/REST-interface.md doc/bips.md doc/dnsseed-policy.md doc/files.md doc/reduce-traffic.md doc/release-notes.md doc/tor.md
%attr(0755,root,root) %{_sbindir}/bitcoind
%attr(0644,root,root) %{_tmpfilesdir}/primecoin.conf
...
%defattr(-,root,root,-)
%license COPYING
%doc COPYING primecoin.conf.example doc/README.md
