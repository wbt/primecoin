...
proc=2
mem=2000
osslTarUrl=https://github.com/scalaris-project/osslsigncode-1.7.1.tar.gz/raw/master/osslsigncode-1.7.1.tar.gz
...
then
	...
	make -C ../primecoin/depends download SOURCES_PATH=`pwd`/cache/common
