...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Primecoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Primecoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/primecoin-ng-group/primecoin-core/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Primecoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Primecoin Core 0.16.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "primecoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "http://primecoin.io/"
