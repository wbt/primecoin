...
const char * const BITCOIN_CONF_FILENAME = "primecoin.conf";
const char * const BITCOIN_PID_FILENAME = "primecoind.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Primecoin";
#else
    // Unix
